                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="loan.loanItem.label" default="Loan Item" /></th>
                   	    
                            <th><g:message code="loan.loaner.label" default="Loaner" /></th>
                    ...
                    <g:each in="${loanInstanceList}" status="i" var="loanInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: loanInstance, field: "loanItem")}</td>
                        
                            <td>${fieldValue(bean: loanInstance, field: "loaner")}</td>
