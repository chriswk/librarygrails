...
<%@ page import="com.isharelib.library.domain.Person" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="projects"><g:message code="person.projects.label" default="Projects" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: personInstance, field: 'projects', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="personType"><g:message code="person.personType.label" default="Person Type" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: personInstance, field: 'personType', 'errors')}">
                                    <g:select name="personType.id" from="${com.isharelib.library.domain.PersonType.list()}" optionKey="id" value="${personInstance?.personType?.id}"  />
                                </td>
                            </tr>
