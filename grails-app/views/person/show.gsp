            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="person.projects.label" default="Projects" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${personInstance.projects}" var="p">
                                    <li><g:link controller="item" action="show" id="${p.id}">${p?.encodeAsHTML()}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="person.personType.label" default="Person Type" /></td>
                            
                            <td valign="top" class="value"><g:link controller="personType" action="show" id="${personInstance?.personType?.id}">${personInstance?.personType?.encodeAsHTML()}</g:link></td>
